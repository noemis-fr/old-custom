...
import pooler
from openerp.addons.e3z_report_ipbox.report import special_message_invoice
...
report_sxw.report_sxw('report.notify_account.invoice', 'account.invoice', 'addons/e3z_report_ipbox/report/special_message_invoice.rml', parser=special_message_invoice.account_invoice_with_message,header="header_invoice")
