...
def onchange_product_id2(self, cr, uid, ids, pricelist_id, product_id, qty, uom_id,
    ...
    context_partner.update({'search': True})
...
purchase.purchase_order_line.onchange_product_id = onchange_product_id2