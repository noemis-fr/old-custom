...
report_sxw.report_sxw('report.account.invoice.affacturage', 'account.invoice', 'addons/e3z_report_ipbox_2/report/report_account_invoice_layout.rml', parser=account_invoice_1,header="header_invoice")
