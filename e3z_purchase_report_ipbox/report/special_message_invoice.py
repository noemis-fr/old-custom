...
report_sxw.report_sxw('report.notify_account.invoice2', 'account.invoice', 'addons/e3z_purchase_report_ipbox/report/special_message_invoice.rml', parser=account_invoice_with_message, header="header_invoice")
